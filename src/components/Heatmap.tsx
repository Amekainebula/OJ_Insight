...
export default function Heatmap({startDay,endDay,daily,onDay}:Props){
  ...
  const { scrollRef, step: STEP, cell: CELL, width, height } = useHeatmapLayout(weeks);
